...
<section class="loginContainer">
	...
	<div id="loginContent" class="loginContents">
		<div id="loginContentBody" class="col-sm-8 loginContentsArea" >
			...
			<div class="col-sm-12 m-b-20">
				<a id="login" class="col-sm-12  btn btn-outline-success btn-sm" >로그인</a>
				<a id="loginNew" class="col-sm-12  btn btn-outline-success btn-sm">간단 회원가입</a>
				<a href="/" id="loginCancel" class="col-sm-12  btn btn-outline-success btn-sm">메인으로</a>
			</div>
		</div>
	</div>
</section>
