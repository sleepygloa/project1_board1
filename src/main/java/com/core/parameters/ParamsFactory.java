...
public final class ParamsFactory
{
  ...
  public static final <T extends Params> Params createParams() { try { return new CommParams();
    } catch (Exception e) {
  ...
  public static final <T extends Params> Params createParams(T params) { if (params.getClass().equals(FileParams.class)) {
      try {
