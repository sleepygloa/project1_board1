...
public class Config
{
  ...
  private static ParagonConfigSubject configSubject; //observer
  private static List<Object> objectList;
  //CombinedConfiguration 은 Config.XXX(") 형태로 xml로 정의된 설정파일을 불러올있다.
  ...
  public static void loadConfig(String type, List<Object> objList)
  {
    ...
    System.out.println("config location -> " + locations);
    if (locations != null) {
