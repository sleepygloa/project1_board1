...
public class SeedCipher {
  ...
  private void seedRound(int[] l0, int[] l1, int[] r0, int[] r1, int[] k) {
    ...
    int t1 = r1[0] ^ k[1];
    t1 ^= t0;
    t00 = t0 >= 0 ? t0 : t0 & 0x7FFFFFFF | 0x80000000;
    t1 = ss0[getB0(t1)] ^ ss1[getB1(t1)] ^ ss2[getB2(t1)] ^ 
      ss3[getB3(t1)];
    t11 = t1 >= 0 ? t1 : t1 & 0x7FFFFFFF | 0x80000000;
    t00 += t11;
  ...
  private void encRoundKeyUpdate0(int[] k, int[] a, int[] b, int[] c, int[] d, int z)
  {
    ...
    k[0] = 
      (ss0[getB0(t00)] ^ ss1[getB1(t00)] ^ ss2[getB2(t00)] ^ ss3[getB3(t00)]);
    k[1] = 
      (ss0[getB0(t11)] ^ ss1[getB1(t11)] ^ ss2[getB2(t11)] ^ ss3[getB3(t11)]);
  }
