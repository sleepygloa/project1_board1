...
public class ResultSetMetaDataInterceptor implements Interceptor
{
  ...
  private static final Log LOG = org.apache.commons.logging.LogFactory.getLog(ResultSetMetaDataInterceptor.class);
  ...
  private void getResultSetMetaData(Invocation invocation) throws SQLException {
    ...
    if (rs != null) {
      ...
      for (int i = 1; i <= columnCount; i++) {
        Map<String, Object> columnMeta = new java.util.LinkedHashMap();
